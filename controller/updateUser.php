<?php
	...
	$tipo = $_POST['tipo'];
		...
		$sql = "UPDATE usuarios SET nombre= '$nombre', usuario= '$usuario', correo= '$email', id_tipo= '$tipo' WHERE id = '$id'";
	...
	<body style="background-color:#DDE0E7 ;">
		<div class="container" style="background-color: white; heigth: 70px;" id="cont">
			<div class="row">
				...
				<a href="../view/configuracion.php" id="btn-acep" class="btn btn">Aceptar</a>
				</div>
				</div>
			</div>
		</div>
