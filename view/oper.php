	...
	<div id='navbar' class='navbar-collapse collapse'>
		...
		<div class="container">
			...
			<a href="../view/admin.php" class="btn btn-info">Inicio</a>
				<a href="../view/nuevo.php" class="btn btn-primary">Nuevo Registro</a>
			</div>
					...
					<tbody>
						<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><a href="../view/modificar.php?id=<?php echo $row['id']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
