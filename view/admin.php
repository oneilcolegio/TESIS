...
<html lang="es">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/js/all.min.js" crossorigin="anonymous">
    ...
    <script>
      ...
      //swal("Bienvenido!", "<?php echo 'Administrador:  '.utf8_decode ($row['nombre']); ?>", "success");
   ...
   <b><a class="navbar-brand" href="admin.html" style="color: #CCECF0;">Unidad Educativa Oneil</a></b>
            ...
            <li class="nav-item dropdown">
               <a class="nav-link dropdown-toggle" id="userDropdown" style="color: #FEFFFF;" href="#" role="button" data-toggle="dropdown"aria-haspopup="true" aria-expanded="false">
                 <?php echo 'ADMINISTRADOR:'.' '.utf8_decode ($row['nombre']); ?>
...
<div id="layoutSidenav_content">
  <br>
       ...
       <div style="background-color: #F7F8FA;">
           ...
           <a class="nav-link" href="../view/oper.php">
            ...
            <a class="nav-link" href="../view/asistencias.php">
              <div class="sb-nav-link-icon"><i class=""></i></i></div>
            ...
            <a class="nav-link" href="../view/configuracion.php">
              <div class="sb-nav-link-icon"><i class=""></i></i></div>
              <img src="../assets/resources/iconos/engranaje.png" alt=""> 
              <br>
               <figcaption class="conf"><h4>Configuración</h4></figcaption></figure>
            </a>

            <a class="nav-link" href="../view/info.php">
              <div class="sb-nav-link-icon"><i class=""></i></i></div>
              <img src="../assets/resources/iconos/informacion.png" alt=""> 
              <br>
              <figcaption class="info"><h4>Información</h4></figcaption></figure>
            </a>
