...
<html lang="es">
	...
	<body>
		<div class="container" style="background-color: #DDE0E7;">
			...
			<br>
			<form class="form-horizontal" method="POST" id="formu" action="../controller/update.php" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<label class="control-label"></label>					
						<a href="../view/oper.php" class="btn btn-info">Regresar</a>
