...
<html lang="es">
	...
	<body>
		<div class="container">
			...
			<br>
			<form class="form-horizontal" method="POST" id="frr" action="../controller/updateAsist_Us.php" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<label class="control-label"></label>
							<br>
						<a href="../view/asistenciasUser.php" class="btn btn-info">Regresar</a>
