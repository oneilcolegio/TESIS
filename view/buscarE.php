...
<html lang="es">
	...
	<div id='navbar' class='navbar-collapse collapse'>
		...
		<div class="container">
			...
			<hr>
			<div class="row">
			<a href="../view/asistencias.php" class="btn btn-success">Menú Asistencias</a>
					...
					<tbody>
						<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td><a href="../view/NewAsist.php?id=<?php echo $row['id']; ?>" ><span class="glyphicon glyphicon-plus"></span></a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
