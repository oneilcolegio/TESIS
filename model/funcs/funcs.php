...
require_once ("conexion.php");
	...
	function resultBlock($errors){
		if(count($errors) > 0)
		{
			...
			<a href='#' onclick=\"showHide('error');\">[ERROR]</a>
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Username = 'jeffvilla052@gmail.com'; //Modificar
		$mail->Password = 'pujzcqrlwkdcwcoj'; //Modificar
		
		$mail->setFrom('jeffvilla052@gmail.com', 'DATA CENTER/UNIDAD EDUCATIVA ONEIL'); //Modificar
