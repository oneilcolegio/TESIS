...
<html lang="es">
	...
	<div class="container">
            ...
            <br>
            <br>
			<form class="form-horizontal" method="POST" id="" action="../controller/guardarAsist.php" autocomplete="off" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<label class="control-label"></label>
						...
						<a href="../view/buscarE.php" class="btn btn-default">Regresar</a>
